 ...
 * @since v3.5.6-1903
 */
public class MarketprojectHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XMZZ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_marketproject_h";
       ...
       */
      // 营销项目追踪应用编码
      public static String CONST_CODE_APPCODE = "91H10530";
      ...
      // 营销项目追踪卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10530_CARD";

      // 营销项目追踪列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10530_LIST";

 ...
 * @since v3.5.6-1903
 */
public class ProfinishHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "PROF";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_projectfinish_h";
       ...
       */
      // 工程完工单应用编码
      public static String CONST_CODE_APPCODE = "91H10515";
      ...
      // 工程完工单卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10515_CARD";

      // 工程完工单列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10515_LIST";

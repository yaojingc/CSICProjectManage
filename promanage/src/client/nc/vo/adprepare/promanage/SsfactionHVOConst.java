 ...
 * @since v3.5.6-1903
 */
public class SsfactionHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XDC1";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_ssfaction_h";
       ...
       */
      // 满意度调查新应用编码
      public static String CONST_CODE_APPCODE = "91H10580";
      ...
      // 满意度调查新卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10580_CARD";

      // 满意度调查新列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10580_LIST";

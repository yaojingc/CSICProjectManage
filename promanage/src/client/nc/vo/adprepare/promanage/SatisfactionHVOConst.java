 ...
 * @since v3.5.6-1903
 */
public class SatisfactionHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "MYDC";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_satisfaction_h";
       ...
       */
      // 满意度调查应用编码
      public static String CONST_CODE_APPCODE = "91H10520";
      ...
      // 满意度调查卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10520_CARD";

      // 满意度调查列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10520_LIST";

 ...
 * @since v3.5.6-1903
 */
public class MlyprojectplanHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "JJJ1";
       ...
       */
      // 新月度计划应用编码
      public static String CONST_CODE_APPCODE = "91H10599";
      ...
      // 新月度计划卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10599_CARD";

      // 新月度计划列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10599_LIST";

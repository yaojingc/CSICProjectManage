 ...
 * @since v3.5.6-1903
 */
public class XunprojectplanHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XPRJ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_time_plan";
       ...
       */
      // 旬计划应用编码
      public static String CONST_CODE_APPCODE = "91H10555";
      ...
      // 旬计划卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10555_CARD";

      // 旬计划列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10555_LIST";

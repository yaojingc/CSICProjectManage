 ...
 * @since v3.5.6-1903
 */
public class CustinformationHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "KHXX";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_information_h";
       ...
       */
      // 客户信息登记应用编码
      public static String CONST_CODE_APPCODE = "91H10540";
      ...
      // 客户信息登记卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10540_CARD";

      // 客户信息登记列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10540_LIST";

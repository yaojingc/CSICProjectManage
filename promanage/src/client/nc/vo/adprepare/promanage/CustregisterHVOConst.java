 ...
 * @since v3.5.6-1903
 */
public class CustregisterHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "CHDJ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_custregister_h";
       ...
       */
      // 客户回访应用编码
      public static String CONST_CODE_APPCODE = "91H10505";
      ...
      // 客户回访卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10505_CARD";

      // 客户回访列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10505_LIST";

 ...
 * @since v3.5.6-1903
 */
public class TenprojectplanHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XUN1";
       ...
       */
      // 项目旬计划应用编码
      public static String CONST_CODE_APPCODE = "91H10560";
      ...
      // 项目旬计划卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10560_CARD";

      // 项目旬计划列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10560_LIST";

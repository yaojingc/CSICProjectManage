 ...
 * @since v3.5.6-1903
 */
public class TendaysprojplanHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "TDPP";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_tendaysprojplan_h";
       ...
       */
      // 项目旬计划应用编码
      public static String CONST_CODE_APPCODE = "91H10550";
      ...
      // 项目旬计划卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "91H10550_CARD";

      // 项目旬计划列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "91H10550_LIST";

 ...
 */
public class SsfactionHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggSsfactionHVO bill : bills) {
  ...
  private Collection<AggSsfactionHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_ssfaction_h",queryParam.getPks());
    Collection<AggSsfactionHVO> bills =
        service.queryBillOfVOByCond(AggSsfactionHVO.class, wheresql, false,
            false);
    return bills;
  }
}

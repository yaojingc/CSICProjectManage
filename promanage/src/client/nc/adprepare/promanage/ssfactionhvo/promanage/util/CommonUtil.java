...
package nc.adprepare.promanage.ssfactionhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static ISsfactionhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return SsfactionHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ISsfactionhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ISsfactionhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(SsfactionHVOConst.CONST_TS, ts);
    }
  }

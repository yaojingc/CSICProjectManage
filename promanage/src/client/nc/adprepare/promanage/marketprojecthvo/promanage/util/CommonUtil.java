...
package nc.adprepare.promanage.marketprojecthvo.promanage.util;
...
public class CommonUtil {
  ...
  private static IMarketprojecthvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return MarketprojectHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IMarketprojecthvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IMarketprojecthvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(MarketprojectHVOConst.CONST_TS, ts);
    }
  }

 ...
 */
public class MarketprojectHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggMarketprojectHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return MarketprojectHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggMarketprojectHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggMarketprojectHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_marketproject_h", queryParam.getPks());
    ...
    return bills.toArray(new AggMarketprojectHVO[0]);
  }
}

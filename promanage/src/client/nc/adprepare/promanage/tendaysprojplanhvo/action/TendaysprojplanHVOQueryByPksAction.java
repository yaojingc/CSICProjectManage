 ...
 */
public class TendaysprojplanHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggTendaysprojplanHVO bill : bills) {
  ...
  private Collection<AggTendaysprojplanHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_tendaysprojplan_h",queryParam.getPks());
    Collection<AggTendaysprojplanHVO> bills =
        service.queryBillOfVOByCond(AggTendaysprojplanHVO.class, wheresql, false,
            false);
    return bills;
  }
}

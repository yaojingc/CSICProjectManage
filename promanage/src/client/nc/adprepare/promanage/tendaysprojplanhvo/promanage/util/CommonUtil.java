...
package nc.adprepare.promanage.tendaysprojplanhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static ITendaysprojplanhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return TendaysprojplanHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ITendaysprojplanhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ITendaysprojplanhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(TendaysprojplanHVOConst.CONST_TS, ts);
    }
  }

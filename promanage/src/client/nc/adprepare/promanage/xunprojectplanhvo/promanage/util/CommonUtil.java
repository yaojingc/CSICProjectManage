...
package nc.adprepare.promanage.xunprojectplanhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static IXunprojectplanhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return XunprojectplanHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IXunprojectplanhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IXunprojectplanhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(XunprojectplanHVOConst.CONST_TS, ts);
    }
  }

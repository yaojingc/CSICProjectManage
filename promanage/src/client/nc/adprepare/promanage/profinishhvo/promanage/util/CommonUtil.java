...
package nc.adprepare.promanage.profinishhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static IProfinishhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return ProfinishHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IProfinishhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IProfinishhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(ProfinishHVOConst.CONST_TS, ts);
    }
  }

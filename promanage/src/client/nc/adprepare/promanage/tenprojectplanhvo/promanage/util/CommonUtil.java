...
package nc.adprepare.promanage.tenprojectplanhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static ITenprojectplanhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return TenprojectplanHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ITenprojectplanhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ITenprojectplanhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(TenprojectplanHVOConst.CONST_TS, ts);
    }
  }

...
package nc.adprepare.promanage.prostarthvo.promanage.util;
...
public class CommonUtil {
  ...
  private static IProstarthvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return ProstartHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IProstarthvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IProstarthvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(ProstartHVOConst.CONST_TS, ts);
    }
  }

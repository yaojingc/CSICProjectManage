 ...
 */
public class ProstartHVOQueryByPksAction implements ICommonAction {
  ...
  private Collection<AggProstartHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_projectstart_h",queryParam.getPks());
    Collection<AggProstartHVO> bills =
        service.queryBillOfVOByCond(AggProstartHVO.class, wheresql, false,
            false);
    return bills;
  }
}

 ...
 */
public class MlyprojectplanHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
      Collection<AggMlyprojectplanHVO> bills) {
    ...
    int i = 0;
    for (AggMlyprojectplanHVO bill : bills) {
   ...
   */
  private Collection<AggMlyprojectplanHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    ...
    Collection<AggMlyprojectplanHVO> bills =
        service.queryBillOfVOByCond(AggMlyprojectplanHVO.class, wheresql, false,
            false);
    return bills;
  }
}

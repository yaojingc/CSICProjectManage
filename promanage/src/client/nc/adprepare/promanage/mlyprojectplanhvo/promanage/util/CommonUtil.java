...
package nc.adprepare.promanage.mlyprojectplanhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static IMlyprojectplanhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return MlyprojectplanHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IMlyprojectplanhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IMlyprojectplanhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(MlyprojectplanHVOConst.CONST_TS, ts);
    }
  }

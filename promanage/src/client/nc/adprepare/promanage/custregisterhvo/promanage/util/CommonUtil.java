...
package nc.adprepare.promanage.custregisterhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static ICustregisterhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return CustregisterHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ICustregisterhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ICustregisterhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(CustregisterHVOConst.CONST_TS, ts);
    }
  }

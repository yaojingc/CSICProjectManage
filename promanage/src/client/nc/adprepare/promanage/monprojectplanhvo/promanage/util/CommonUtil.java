...
package nc.adprepare.promanage.monprojectplanhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static IMonprojectplanhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return MonprojectplanHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IMonprojectplanhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IMonprojectplanhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(MonprojectplanHVOConst.CONST_TS, ts);
    }
  }

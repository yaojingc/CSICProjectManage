...
package nc.adprepare.promanage.satisfactionhvo.promanage.util;
...
public class CommonUtil {
  ...
  private static ISatisfactionhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return SatisfactionHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ISatisfactionhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ISatisfactionhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(SatisfactionHVOConst.CONST_TS, ts);
    }
  }

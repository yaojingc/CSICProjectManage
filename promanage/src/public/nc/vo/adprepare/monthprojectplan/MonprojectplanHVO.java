...
public class MonprojectplanHVO extends SuperVO {
	
/**
*项目月度计划主表主键
*/
public java.lang.String pk_monthprojplan_h;
/**
*集团
*/
...
/**
* 属性 pk_monthprojplan_h的Getter方法.属性名：项目月度计划主表主键
*  创建日期:2020-5-20
* @return java.lang.String
*/
public java.lang.String getPk_monthprojplan_h() {
return this.pk_monthprojplan_h;
} 

/**
* 属性pk_monthprojplan_h的Setter方法.属性名：项目月度计划主表主键
* 创建日期:2020-5-20
* @param newPk_monthprojplan_h java.lang.String
*/
public void setPk_monthprojplan_h ( java.lang.String pk_monthprojplan_h) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.monprojectplanHVO");
    }
   }

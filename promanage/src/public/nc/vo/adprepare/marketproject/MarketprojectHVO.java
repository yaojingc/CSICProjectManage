...
public class MarketprojectHVO extends SuperVO {
	
/**
*营销项目主表主键
*/
public java.lang.String pk_marketproject_h;
/**
*集团
*/
...
*经办部门名称
*/
public java.lang.String handingdept;
/**
*经办人名称
*/
public java.lang.String handingperson;
/**
*大客户经理
*/
public java.lang.String accmanager;
/**
*客户受访人
*/
public java.lang.String cinterviewee;
/**
*职务
*/
...
*当前进度
*/
public java.lang.String currprogress;
/**
*工程名称
*/
...
/**
* 属性 pk_marketproject_h的Getter方法.属性名：营销项目主表主键
*  创建日期:2020-5-8
* @return java.lang.String
*/
public java.lang.String getPk_marketproject_h() {
return this.pk_marketproject_h;
} 

/**
* 属性pk_marketproject_h的Setter方法.属性名：营销项目主表主键
* 创建日期:2020-5-8
* @param newPk_marketproject_h java.lang.String
*/
public void setPk_marketproject_h ( java.lang.String pk_marketproject_h) {
this.pk_marketproject_h=pk_marketproject_h;
} 
...
/**
* 属性 revisitdate的Getter方法.属性名：回访日期
*  创建日期:2020-5-8
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getRevisitdate() {
return this.revisitdate;
} 

/**
* 属性revisitdate的Setter方法.属性名：回访日期
* 创建日期:2020-5-8
* @param newRevisitdate nc.vo.pub.lang.UFDate
*/
public void setRevisitdate ( UFDate revisitdate) {
...
* 创建日期:2020-5-8
* @param newCustname nc.vo.bd.cust.CustomerVO
*/
...
/**
* 属性 handingdept的Getter方法.属性名：经办部门名称
*  创建日期:2020-5-8
* @return nc.vo.org.DeptVO
*/
public java.lang.String getHandingdept() {
return this.handingdept;
} 

/**
* 属性handingdept的Setter方法.属性名：经办部门名称
* 创建日期:2020-5-8
* @param newHandingdept nc.vo.org.DeptVO
*/
public void setHandingdept ( java.lang.String handingdept) {
this.handingdept=handingdept;
} 
 
/**
* 属性 handingperson的Getter方法.属性名：经办人名称
*  创建日期:2020-5-8
* @return nc.vo.bd.psn.PsndocVO
*/
public java.lang.String getHandingperson() {
return this.handingperson;
} 

/**
* 属性handingperson的Setter方法.属性名：经办人名称
* 创建日期:2020-5-8
* @param newHandingperson nc.vo.bd.psn.PsndocVO
*/
public void setHandingperson ( java.lang.String handingperson) {
this.handingperson=handingperson;
} 
 
/**
* 属性 accmanager的Getter方法.属性名：大客户经理
*  创建日期:2020-5-8
* @return nc.vo.bd.psn.PsndocVO
*/
public java.lang.String getAccmanager() {
return this.accmanager;
} 

/**
* 属性accmanager的Setter方法.属性名：大客户经理
* 创建日期:2020-5-8
* @param newAccmanager nc.vo.bd.psn.PsndocVO
*/
public void setAccmanager ( java.lang.String accmanager) {
this.accmanager=accmanager;
} 
 
/**
* 属性 cinterviewee的Getter方法.属性名：客户受访人
*  创建日期:2020-5-8
* @return java.lang.String
*/
public java.lang.String getCinterviewee() {
return this.cinterviewee;
} 

/**
* 属性cinterviewee的Setter方法.属性名：客户受访人
* 创建日期:2020-5-8
* @param newCinterviewee java.lang.String
*/
public void setCinterviewee ( java.lang.String cinterviewee) {
this.cinterviewee=cinterviewee;
} 
 
/**
* 属性 post的Getter方法.属性名：职务
*  创建日期:2020-5-8
* @return java.lang.String
*/
...
/**
* 属性 currprogress的Getter方法.属性名：当前进度
*  创建日期:2020-5-8
* @return java.lang.String
*/
public java.lang.String getCurrprogress() {
return this.currprogress;
} 

/**
* 属性currprogress的Setter方法.属性名：当前进度
* 创建日期:2020-5-8
* @param newCurrprogress java.lang.String
*/
public void setCurrprogress ( java.lang.String currprogress) {
this.currprogress=currprogress;
} 
 
/**
* 属性 proname的Getter方法.属性名：工程名称
*  创建日期:2020-5-8
* @return java.lang.String
*/
...
/**
* 属性proname的Setter方法.属性名：工程名称
* 创建日期:2020-5-8
* @param newProname java.lang.String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.marketprojectHVO");
    }
   }

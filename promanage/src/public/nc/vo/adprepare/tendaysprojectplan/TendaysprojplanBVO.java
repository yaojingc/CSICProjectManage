...
public class TendaysprojplanBVO extends SuperVO {
	
/**
*项目旬计划子表主键
*/
public java.lang.String pk_tendaysprojectplan_b;
/**
*级内序号
*/
...
*计划截止日期
*/
public java.lang.Integer plan_end_date;
/**
*备注
*/
...
*上层单据主键
*/
public String pk_tendaysprojplan_h;
/**
*时间戳
*/
...
/**
* 属性 pk_tendaysprojectplan_b的Getter方法.属性名：项目旬计划子表主键
*  创建日期:2020-5-20
* @return java.lang.String
*/
public java.lang.String getPk_tendaysprojectplan_b() {
return this.pk_tendaysprojectplan_b;
} 

/**
* 属性pk_tendaysprojectplan_b的Setter方法.属性名：项目旬计划子表主键
* 创建日期:2020-5-20
* @param newPk_tendaysprojectplan_b java.lang.String
*/
public void setPk_tendaysprojectplan_b ( java.lang.String pk_tendaysprojectplan_b) {
this.pk_tendaysprojectplan_b=pk_tendaysprojectplan_b;
} 
...
* @return java.lang.Integer
*/
public java.lang.Integer getPlan_end_date() {
...
*/
public void setPlan_end_date ( java.lang.Integer plan_end_date) {
...
* @return String
*/
public String getPk_tendaysprojplan_h(){
return this.pk_tendaysprojplan_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-5-20
* @param newPk_tendaysprojplan_h String
*/
public void setPk_tendaysprojplan_h(String pk_tendaysprojplan_h){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.tendaysprojplanBVO");
    }
   }

...
public class ProjectstartBVO extends SuperVO {
	
/**
*工程开工单子表主键
*/
public java.lang.String pk_projectstart_b;
/**
*行号
*/
...
*上层单据主键
*/
public String pk_projectstart_h;
/**
*时间戳
*/
...
/**
* 属性 pk_projectstart_b的Getter方法.属性名：工程开工单子表主键
*  创建日期:2020-5-4
* @return java.lang.String
*/
public java.lang.String getPk_projectstart_b() {
return this.pk_projectstart_b;
} 

/**
* 属性pk_projectstart_b的Setter方法.属性名：工程开工单子表主键
* 创建日期:2020-5-4
* @param newPk_projectstart_b java.lang.String
*/
public void setPk_projectstart_b ( java.lang.String pk_projectstart_b) {
this.pk_projectstart_b=pk_projectstart_b;
} 
...
* @return String
*/
public String getPk_projectstart_h(){
return this.pk_projectstart_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-5-4
* @param newPk_projectstart_h String
*/
public void setPk_projectstart_h(String pk_projectstart_h){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.projectstartBVO");
    }
   }

...
public class ProfinishBVO extends SuperVO {
	
/**
*工程完工单子表主键
*/
public java.lang.String pk_projectfinish_b;
/**
*行号
*/
...
*上层单据主键
*/
public String pk_projectfinish_h;
/**
*时间戳
*/
...
/**
* 属性 pk_projectfinish_b的Getter方法.属性名：工程完工单子表主键
*  创建日期:2020-5-4
* @return java.lang.String
*/
public java.lang.String getPk_projectfinish_b() {
return this.pk_projectfinish_b;
} 

/**
* 属性pk_projectfinish_b的Setter方法.属性名：工程完工单子表主键
* 创建日期:2020-5-4
* @param newPk_projectfinish_b java.lang.String
*/
public void setPk_projectfinish_b ( java.lang.String pk_projectfinish_b) {
this.pk_projectfinish_b=pk_projectfinish_b;
} 
...
* @return String
*/
public String getPk_projectfinish_h(){
return this.pk_projectfinish_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-5-4
* @param newPk_projectfinish_h String
*/
public void setPk_projectfinish_h(String pk_projectfinish_h){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.profinishBVO");
    }
   }

...
public class MlyprojectplanHVO extends SuperVO {
...
/**
* 属性 pk_time_plan的Getter方法.属性名：计划主键
*  创建日期:2020-6-19
...
/**
* 属性pk_time_plan的Setter方法.属性名：计划主键
* 创建日期:2020-6-19
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.mlyprojectplanHVO");
    }
   }

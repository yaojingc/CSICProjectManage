...
public class CustvisitregBVO extends SuperVO {
	
/**
*客户回访子表主键
*/
public java.lang.String pk_custvisitreg_b;
/**
*行号
*/
...
*上层单据主键
*/
public String pk_custrevisitreg_h;
/**
*时间戳
*/
...
/**
* 属性 pk_custvisitreg_b的Getter方法.属性名：客户回访子表主键
*  创建日期:2020-5-3
* @return java.lang.String
*/
public java.lang.String getPk_custvisitreg_b() {
return this.pk_custvisitreg_b;
} 

/**
* 属性pk_custvisitreg_b的Setter方法.属性名：客户回访子表主键
* 创建日期:2020-5-3
* @param newPk_custvisitreg_b java.lang.String
*/
public void setPk_custvisitreg_b ( java.lang.String pk_custvisitreg_b) {
this.pk_custvisitreg_b=pk_custvisitreg_b;
} 
...
* @return String
*/
public String getPk_custrevisitreg_h(){
return this.pk_custrevisitreg_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-5-3
* @param newPk_custrevisitreg_h String
*/
public void setPk_custrevisitreg_h(String pk_custrevisitreg_h){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.custvisitregBVO");
    }
   }

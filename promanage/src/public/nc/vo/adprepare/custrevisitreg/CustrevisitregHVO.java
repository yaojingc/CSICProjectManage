...
public class CustrevisitregHVO extends SuperVO {
	
/**
*客户回访登记主表主键
*/
public java.lang.String pk_custrevisitreg_h;
/**
*集团
*/
...
/**
* 属性 pk_custrevisitreg_h的Getter方法.属性名：客户回访登记主表主键
*  创建日期:2020-5-3
* @return java.lang.String
*/
public java.lang.String getPk_custrevisitreg_h() {
return this.pk_custrevisitreg_h;
} 

/**
* 属性pk_custrevisitreg_h的Setter方法.属性名：客户回访登记主表主键
* 创建日期:2020-5-3
* @param newPk_custrevisitreg_h java.lang.String
*/
public void setPk_custrevisitreg_h ( java.lang.String pk_custrevisitreg_h) {
this.pk_custrevisitreg_h=pk_custrevisitreg_h;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.custrevisitregHVO");
    }
   }

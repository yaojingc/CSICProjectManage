...
public class SsfactionBVO extends SuperVO {
	
/**
*调查子表主键
*/
public java.lang.String pk_ssfaction_b;
/**
*行号
*/
...
/**
* 属性 pk_ssfaction_b的Getter方法.属性名：调查子表主键
*  创建日期:2020-6-15
* @return java.lang.String
*/
public java.lang.String getPk_ssfaction_b() {
return this.pk_ssfaction_b;
} 

/**
* 属性pk_ssfaction_b的Setter方法.属性名：调查子表主键
* 创建日期:2020-6-15
* @param newPk_ssfaction_b java.lang.String
*/
public void setPk_ssfaction_b ( java.lang.String pk_ssfaction_b) {
this.pk_ssfaction_b=pk_ssfaction_b;
} 
...
* @return String
*/
public String getPk_ssfaction_h(){
return this.pk_ssfaction_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-6-15
* @param newPk_ssfaction_h String
*/
public void setPk_ssfaction_h(String pk_ssfaction_h){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.ssfactionBVO");
    }
   }

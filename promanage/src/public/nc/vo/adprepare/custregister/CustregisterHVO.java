...
public class CustregisterHVO extends SuperVO {
	
/**
*客户回访登记主表主键
*/
public java.lang.String pk_custregister_h;
/**
*审批时间
*/
...
/**
* 属性 pk_custregister_h的Getter方法.属性名：客户回访登记主表主键
*  创建日期:2020-5-4
* @return java.lang.String
*/
public java.lang.String getPk_custregister_h() {
return this.pk_custregister_h;
} 

/**
* 属性pk_custregister_h的Setter方法.属性名：客户回访登记主表主键
* 创建日期:2020-5-4
* @param newPk_custregister_h java.lang.String
*/
public void setPk_custregister_h ( java.lang.String pk_custregister_h) {
this.pk_custregister_h=pk_custregister_h;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.custregisterHVO");
    }
   }

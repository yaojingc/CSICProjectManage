...
public class CustregisterBVO extends SuperVO {
	
/**
*客户回访子表主键
*/
public java.lang.String pk_custregister_b;
/**
*行号
*/
...
*上层单据主键
*/
public String pk_custregister_h;
/**
*时间戳
*/
...
/**
* 属性 pk_custregister_b的Getter方法.属性名：客户回访子表主键
*  创建日期:2020-5-4
* @return java.lang.String
*/
public java.lang.String getPk_custregister_b() {
return this.pk_custregister_b;
} 

/**
* 属性pk_custregister_b的Setter方法.属性名：客户回访子表主键
* 创建日期:2020-5-4
* @param newPk_custregister_b java.lang.String
*/
public void setPk_custregister_b ( java.lang.String pk_custregister_b) {
this.pk_custregister_b=pk_custregister_b;
} 
...
* @return String
*/
public String getPk_custregister_h(){
return this.pk_custregister_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-5-4
* @param newPk_custregister_h String
*/
public void setPk_custregister_h(String pk_custregister_h){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.custregisterBVO");
    }
   }

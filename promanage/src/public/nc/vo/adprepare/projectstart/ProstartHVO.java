...
public class ProstartHVO extends SuperVO {
...
*工程合同
*/
public UFBoolean projectcontract;
/**
*工程预付款情况
*/
...
*施工方案
*/
public UFBoolean constractionplan;
/**
*预缴
*/
public UFBoolean advancepayment;
/**
*计税方式
*/
...
*/
public UFBoolean getProjectcontract() {
...
*/
public void setProjectcontract ( UFBoolean projectcontract) {
...
* @return nc.vo.pub.lang.UFBoolean
*/
public UFBoolean getConstractionplan() {
...
*/
public void setConstractionplan ( UFBoolean constractionplan) {
...
* @return nc.vo.pub.lang.UFBoolean
*/
public UFBoolean getAdvancepayment() {
...
*/
public void setAdvancepayment ( UFBoolean advancepayment) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.prostartHVO");
    }
   }

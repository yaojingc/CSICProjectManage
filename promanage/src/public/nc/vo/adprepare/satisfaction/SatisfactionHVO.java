...
public class SatisfactionHVO extends SuperVO {
	
/**
*满意度主表主键
*/
public java.lang.String pk_satisfaction_h;
/**
*集团
*/
...
/**
* 属性 pk_satisfaction_h的Getter方法.属性名：满意度主表主键
*  创建日期:2020-5-8
* @return java.lang.String
*/
public java.lang.String getPk_satisfaction_h() {
return this.pk_satisfaction_h;
} 

/**
* 属性pk_satisfaction_h的Setter方法.属性名：满意度主表主键
* 创建日期:2020-5-8
* @param newPk_satisfaction_h java.lang.String
*/
public void setPk_satisfaction_h ( java.lang.String pk_satisfaction_h) {
this.pk_satisfaction_h=pk_satisfaction_h;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("adprepare.satisfactionHVO");
    }
   }

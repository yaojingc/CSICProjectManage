...
//应用编码
export const APPCODE = '91H10555';

//单据类型
export const BILL_TYPE_CODE = 'XPRJ';
 ...
 */
export const LIST = {
        page_title: '91H10555-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10555_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savexunprojectplanHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletexunprojectplanHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardxunprojectplanHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagexunprojectplanHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkxunprojectplanHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitxunprojectplanHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitxunprojectplanHVO.do`,               //收回

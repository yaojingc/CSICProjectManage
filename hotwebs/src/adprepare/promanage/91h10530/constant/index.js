/*
 * @Author: Your name
 * @Date:   2020-05-08 16:57:44
 * @Last Modified by:   Your name
 * @Last Modified time: 2020-05-08 16:58:51
 */
/**
* @description: 常量
*/
...
//应用编码
export const APPCODE = '91H10530';

//单据类型
export const BILL_TYPE_CODE = 'XMZZ';
 ...
 */
export const LIST = {
        page_title: '91H10530-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10530_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savemarketprojectHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletemarketprojectHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardmarketprojectHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagemarketprojectHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkmarketprojectHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitmarketprojectHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitmarketprojectHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_marketproject_h',           //表头主键字段名
        body_id: 'pk_marketproject_b',           //表体主键字段名

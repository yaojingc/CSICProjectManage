/*
 * @Author: Your name
 * @Date:   2020-05-28 16:02:22
 * @Last Modified by:   Your name
 * @Last Modified time: 2020-05-28 19:27:03
 */
...
export function buttonVisibilityControl(props) {
    ...
    */
    ...
    CARD_BUTTON.insertRow, CARD_BUTTON.delRow, CARD_BUTTON.copyRow, CARD_BUTTON.pasteHere, CARD_BUTTON.expand,CARD_BUTTON.addRowProject,CARD_BUTTON.deleteRowProject];
    //联查按钮
    ...
    //设置卡片状态
    props.cardTable.setStatus(CARD.table_code_linkperson, isBrowse ? STATUS.browse : STATUS.edit);

/*
 * @Author: Your name
 * @Date:   2020-05-25 18:38:40
 * @Last Modified by:   Your name
 * @Last Modified time: 2020-05-28 17:33:07
 */
...
class Card extends Component {
        ...
        componentWillMount() {
                ...
                window.onbeforeunload = () => {
                        let status = this.props.cardTable.getStatus(CARD.table_code_linkperson);
                        if (status == STATUS.edit) {
                                return this.state.json['91H10540-000007'];/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                        }
                };
        }
        ...
        getTableHead2 = () => {
                return <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_project,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
                        ...
                        <div className="nc-bill-card">
                                ...
                                <div className="nc-bill-bottom-area">
                                        <div className="nc-bill-table-area">
                                                {createCardTable(CARD.table_code_linkperson, {
                                                 ...
                                                 {createCardTable(CARD.table_code_project, {
                                                        tableHead: this.getTableHead2.bind(this),
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['91H10540-000018']} /* 国际化处理： 指派*/
...
Card = createPage({
        billinfo: {
                ...
                bodycode: CARD.table_code_linkperson
        }
})(Card);
export default Card;

...
//应用编码
export const APPCODE = '91H10545';

//单据类型
export const BILL_TYPE_CODE = 'MPJP';

let cardpageindex = 1

export const Initcardpageindex = (data) => {
        debugger
        if (data == 1) {
                cardpageindex += data;
        }else if(data == 2){
 ...
 */
export const LIST = {
        page_title: '91H10545-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10545_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savemonprojectplanHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletemonprojectplanHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardmonprojectplanHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagemonprojectplanHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkmonprojectplanHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitmonprojectplanHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitmonprojectplanHVO.do`,               //收回
...
export const FIELD = {
        org: 'pk_org',                                                   //组织
        orgV: 'pk_org_v',                                              //组织多版本
        billStatus: 'bill_status',                                //单据状态字段（用以按钮控制）
        ts: 'ts'                                                                 //时间戳
};

//主属性字段名
export const PRIMARY_KEY = {
        head_id: 'pk_monthprojplan_h',           //表头主键字段名
        body_id: 'pk_monthprojectplan_b',           //表体主键字段名

...
import { bodyAfterEvent } from './events/afterEvent';

import { bodyBeforeEvent } from './events/bodyBeforeEvent_month';
...
* @description: 卡片
* 卡片态还存在的问题:
* 1.列表态双击表体行进入卡片态(左树右图),显示两条查询成功问题
* 2.列表态点击新增进入卡片编辑态时界面初始化会显示两条表体行问题
*
*/
const { NCAffix } = base;
					...
					<NCAffix>
						<div className="nc-bill-header-area">
							{createCardTitleArea.call(this, this.props, {
								title: this.props.type == 'qq' ? '前期任务编制' : '计划编制',

					...
					if (res.data) {
						...
						if (body && body[cardTableId]) {
							body[cardTableId].rows.forEach(cur => {
								...
								//cur.values.pk_front_plan = {display :cur.values.pk_front_plan.value ,value: cur.values.pk_front_plan.value };
								cur.values.duration = { value: cur.values.duration.value };
							})

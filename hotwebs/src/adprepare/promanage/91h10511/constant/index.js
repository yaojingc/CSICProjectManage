...
//应用编码
export const APPCODE = '91H10511';

//单据类型
export const BILL_TYPE_CODE = 'PROS';
 ...
 */
export const LIST = {
        page_title: '91H10511-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10511_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/saveprostartHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deleteprostartHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardprostartHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypageprostartHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkprostartHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitprostartHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitprostartHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_projectstart_h',           //表头主键字段名
        body_id: 'pk_projectstart_b',           //表体主键字段名

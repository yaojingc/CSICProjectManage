...
//应用编码
export const APPCODE = '91H10550';

//单据类型
export const BILL_TYPE_CODE = 'TDPP';
 ...
 */
export const LIST = {
        page_title: '91H10550-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10550_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savetendaysprojplanHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletetendaysprojplanHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardtendaysprojplanHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagetendaysprojplanHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypktendaysprojplanHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/committendaysprojplanHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommittendaysprojplanHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_tendaysprojplan_h',           //表头主键字段名
        body_id: 'pk_tendaysprojectplan_b',           //表体主键字段名

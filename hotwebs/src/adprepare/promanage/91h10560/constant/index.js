...
//应用编码
export const APPCODE = '91H10560';

//单据类型
export const BILL_TYPE_CODE = 'XUN1';
 ...
 */
export const LIST = {
        page_title: '91H10560-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10560_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savetenprojectplanHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletetenprojectplanHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardtenprojectplanHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagetenprojectplanHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypktenprojectplanHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/committenprojectplanHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommittenprojectplanHVO.do`,               //收回
...
//卡片新增禁用按钮
 export const CARD_ADD_DISABLED_BUTTON = [];
...
export const PRIMARY_KEY = {
        head_id: 'pk_time_plan',           //表头主键字段名
        body_id: 'pk_time_plan_item',           //表体主键字段名

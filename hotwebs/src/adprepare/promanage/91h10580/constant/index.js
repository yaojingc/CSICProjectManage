...
//应用编码
export const APPCODE = '91H10580';

//单据类型
export const BILL_TYPE_CODE = 'XDC1';
 ...
 */
export const LIST = {
        page_title: '91H10580-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10580_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savessfactionHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletessfactionHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardssfactionHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagessfactionHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkssfactionHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitssfactionHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitssfactionHVO.do`,               //收回
...
export const FIELD = {
        org: 'pk_org',                                                   //组织
        //orgV: 'pk_org_v',                                              //组织多版本
        billStatus: 'fstatusflag',                                //单据状态字段（用以按钮控制）
        ts: 'ts'                                                                 //时间戳
};

//主属性字段名
export const PRIMARY_KEY = {
        head_id: 'pk_ssfaction_h',           //表头主键字段名
        body_id: 'pk_ssfaction_b',           //表体主键字段名
        bill_no: 'vbillcode',                                               //单据编号字段名
        id: 'id'                                                                 //单据前端缓存标识
};

...
//应用编码
export const APPCODE = '91H10599';

//单据类型
export const BILL_TYPE_CODE = 'JJJ1';
 ...
 */
export const LIST = {
        page_title: '91H10599-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10599_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savemlyprojectplanHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletemlyprojectplanHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardmlyprojectplanHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagemlyprojectplanHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkmlyprojectplanHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitmlyprojectplanHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitmlyprojectplanHVO.do`,               //收回

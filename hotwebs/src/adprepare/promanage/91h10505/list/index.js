...
// import { ModalDemo1 } from './events//modalDemo';
import { searchBtnClick } from './events/searchBtnClick';
import { selectedEvent, selectedAllEvent } from './events/selectedEvent';
import { LIST_BUTTON, SEARCH_CACHE, LIST, MULTILANG, PRIMARY_KEY, BILL_TYPE_CODE,LIST_DISABLED_BUTTON } from '../constant';
...
class List extends Component {
        ...
        render() {
                ...
                this.props.button.setButtonDisabled(LIST_DISABLED_BUTTON, true);
                ...
                return (
                        <div className="nc-bill-list">
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['91H10505-000018']} /* 国际化处理： 指派*/

...
//应用编码
export const APPCODE = '91H10505';

//单据类型
export const BILL_TYPE_CODE = 'CHDJ';
 ...
 */
export const LIST = {
        page_title: '91H10505-000011',                  //页面标题 /* 国际化处理： 投融资费用   91H10505-000011*/

        page_code: '91H10505_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/adprepare/promanage/savecustregisterHVO.do`,                       //保存
        delete: `/nccloud/adprepare/promanage/deletecustregisterHVO.do`,                        //删除
        queryCard: `/nccloud/adprepare/promanage/querycardcustregisterHVO.do`,                      //卡片查询
        queryList: `/nccloud/adprepare/promanage/querypagecustregisterHVO.do`,              //列表查询
        queryListByPks: `/nccloud/adprepare/promanage/querypagebypkcustregisterHVO.do`,     //列表分页查询
        commit: `/nccloud/adprepare/promanage/commitcustregisterHVO.do`,                   //提交
        unCommit: `/nccloud/adprepare/promanage/uncommitcustregisterHVO.do`,               //收回

        // 添加一个新增的请求 往页面上赋值几个默认字段值
        add: `/nccloud/adprepare/promanage/addcustregisterHVO.do`,  
...
export const FIELD = {
        org: 'pk_org',                                                   //组织
        //orgV: 'pk_org_v',                                              //组织多版本
        billStatus: 'fstatusflag', //fstatusflag      billstatus                          //单据状态字段（用以按钮控制）
        ts: 'ts'                                                                 //时间戳
};

//主属性字段名
export const PRIMARY_KEY = {
        head_id: 'pk_custregister_h',           //表头主键字段名
        body_id: 'pk_custregister_b',           //表体主键字段名
        bill_no: 'vbillcode',      //vbillcode     billno系统默认                                     //单据编号字段名
        id: 'id'                                                                 //单据前端缓存标识
};
